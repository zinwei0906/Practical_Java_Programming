...
public final class ComputeLoan2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("    <head>\n");
      out.write("        <title>ComputeLoan2: Compute Loan Using the Loan Class</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        \n");
      out.write("        ");
 double loanAmount = Double.parseDouble(request.getParameter("loanAmount"));
      ...
      out.print( String.format("%.2f", loanAmount) );
      out.write("<br />\n");
      out.write("        Annual Interest Rate: ");
      out.print( String.format("%.2f", annualInterestRate) );
      out.write("<br />\n");
      out.write("        Number of Years: ");
      out.print( numberOfYears);
      out.write("<br />\n");
      out.write("        <b>Monthly Payment: RM");
      out.print( String.format("%.2f", monthlyPayment) );
      out.write("<br />\n");
      out.write("            Total Payment: RM");
      out.print( String.format("%.2f", totalPayment) );
      out.write("<br /></b>\n");
      out.write("    </body>\n");
      out.write("</html>\n");
    } catch (Throwable t) {
