...
public class P2Q1 extends JFrame {
    ...
    class GreenListenerClass implements ActionListener {
    ...
    class BlueListenerClass implements ActionListener {
    ...
    public P2Q1() {
        ...
        Red.addActionListener(new RedListenerClass());
        Green.addActionListener(new GreenListenerClass());
        Blue.addActionListener(new BlueListenerClass());
