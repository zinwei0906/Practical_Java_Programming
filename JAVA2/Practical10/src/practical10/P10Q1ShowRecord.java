...
public class P10Q1ShowRecord extends JFrame {
    ...
    public P10Q1ShowRecord() {
        Font font = new Font("TimesRoman", Font.BOLD, 20);
        JPanel jpCenter = new JPanel(new GridLayout(3, 2));
        jpCenter.add(new JLabel("Programme Code")).setFont(font);
        jpCenter.add(jtfCode).setFont(font);
        jpCenter.add(new JLabel("Programme Name")).setFont(font);
        jpCenter.add(jtfName).setFont(font);
        jpCenter.add(new JLabel("Faculty")).setFont(font);
        jpCenter.add(jtfFaculty).setFont(font);
        add(jpCenter);

        JPanel jpSouth = new JPanel();
        jpSouth.add(jbtFirst).setFont(font);
        jpSouth.add(jbtPrevious).setFont(font);
        jpSouth.add(jbtNext).setFont(font);
        jpSouth.add(jbtLast).setFont(font);
    ...
    public static void main(String[] args) {
        P10Q1ShowRecord frm = new P10Q1ShowRecord();
