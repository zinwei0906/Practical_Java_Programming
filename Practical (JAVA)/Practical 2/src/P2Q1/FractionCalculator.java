...
public class FractionCalculator extends javax.swing.JFrame {
    ...
    private P2Q1FractionInterface Fraction1 = new P2Q1Fraction();
    private P2Q1FractionInterface Fraction2 = new P2Q1Fraction();
  ...
  private void jbtAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtAddActionPerformed
      try {
          getInput();
          P2Q1FractionInterface ResultFraction = Fraction1.Addition(Fraction2).SimplifyFraction();
          String result = Fraction1.toString() + " + " + Fraction2.toString() + " = " + ResultFraction.toString();
  ...
  private void jbtSubtractActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSubtractActionPerformed
      try {
          getInput();
          P2Q1FractionInterface ResultFraction = Fraction1.Subtraction(Fraction2).SimplifyFraction();
          String result = Fraction1.toString() + " - " + Fraction2.toString() + " = " + ResultFraction.toString();
          jtfResult.setText(result);
      } catch (Exception ex) {
          JOptionPane.showMessageDialog(null, "Invalid Input", "ERROR", JOptionPane.ERROR_MESSAGE);
  ...
  private void jbtMultiplyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtMultiplyActionPerformed
      try {
          getInput();
          P2Q1FractionInterface ResultFraction = Fraction1.Multiplication(Fraction2).SimplifyFraction();
          String result = Fraction1.toString() + " * " + Fraction2.toString() + " = " + ResultFraction.toString();
          jtfResult.setText(result);
      } catch (Exception ex) {
          JOptionPane.showMessageDialog(null, "Invalid Input", "ERROR", JOptionPane.ERROR_MESSAGE);
  ...
  private void jbtDivideActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtDivideActionPerformed
      try {
          getInput();
          P2Q1FractionInterface ResultFraction = Fraction1.Division(Fraction2).SimplifyFraction();
          String result = Fraction1.toString() + " / " + Fraction2.toString() + " = " + ResultFraction.toString();
          jtfResult.setText(result);
      } catch (Exception ex) {
          JOptionPane.showMessageDialog(null, "Invalid Input", "ERROR", JOptionPane.ERROR_MESSAGE);
