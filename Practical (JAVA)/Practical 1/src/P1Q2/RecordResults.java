...
public class RecordResults extends javax.swing.JFrame {
  ...
  private void jbtConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtConfirmActionPerformed
      ...
      try {
          if (runner == null) {
              JOptionPane.showMessageDialog(null, "Please Enter Runner Number", "ERROR", JOptionPane.ERROR_MESSAGE);
          } else {
              for (int num = 0; num < finisherList.size(); num++) {
                  if (finisherList.get(num).getNumber() == runner.getNumber()) {
                      JOptionPane.showMessageDialog(null, "The Runner Number Already Record", "ERROR", JOptionPane.ERROR_MESSAGE);
                      runner = null;
                  }
              }
              if (runner != null) {
  ...
  private void jtfNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfNumberActionPerformed
      ...
      try {
          ...
          for (int num = 0; num < runnerList.size(); num++) {
              if (runnerList.get(num).getNumber() == number) {
                  runner = runnerList.get(num);
                  jtfName.setText("" + runner.getName());
              }
          }
          if (runner == null) {
              JOptionPane.showMessageDialog(null, "The Number Didn't Register", "ERROR", JOptionPane.ERROR_MESSAGE);
          }
      } catch (Exception ex) {
          JOptionPane.showMessageDialog(null, "Invalid Runner Number", "ERROR", JOptionPane.ERROR_MESSAGE);
      }
